...
const AllBooks = () => {
    return (
        <div>
            <div id="allBooks " className="py-[80px]">
                <div className="containers">
                    ...
                    <div className="allBooks">
                        <div className="flex items-center pt-[60px] justify-between">
                            ...
                            <div
                                className="flex items-center justify-between w-[160px] px-[10px] border-[1px] border-[#818EEA] rounded-[12px] h-[37px]">
